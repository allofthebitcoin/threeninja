THREE NINJA uses code from HTML5 UP's publicly available library of static site themes and templates. Many thanks to AJ and friends of HTML5 UP.

The following are original comments from HTML5 UP
